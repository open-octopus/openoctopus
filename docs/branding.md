...
| 品牌气质 | 聪明、多面、沉稳而有力——像章鱼一样，安静观察、多线并行、精准行动 |
| 目标受众 | 追求人生系统化治理的个人用户、一人公司创业者、知识工作者 |
| 品牌精神 | 分域掌控、万物可召唤、持续进化、开放协作 |
| 两大关键词 | **Realm**（域）— 人生分域治理；**Summon**（召唤）— 万物皆可 Agent |
...
| 组件 | 命名 | 来源隐喻 |
|---|---|---|
| 域包分享市场 | **RealmHub** | 域能力集散中心 |
| CLI 工具 | **tentacle** | 触手 = 命令行延伸触达 |
...
2. **触手发光 = Summon 召唤**
   深海章鱼的触手末端会发出生物光。在 OpenOctopus 中，这道光就是"召唤"——触手触碰到什么，什么就获得数字生命。

3. **中央大脑 = 跨域协同**
   章鱼的中央大脑协调所有触手。OpenOctopus Core 同理——跨域知识图谱让所有 Realm 的信息互联互通。
